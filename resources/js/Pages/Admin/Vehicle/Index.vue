        ...
        <table>
          <thead>
            <tr>
              ...
              <th>
                <Sort label="Fuel C (Liter/KM)" attribute="fuel" />
              </th>
              <th>
                <Sort label="Service Schedule" attribute="service" />
              </th>
          ...
          <tbody>
            <tr v-for="vehicle in vehicles.data" :key="vehicle.id">
              <td data-label="Name">
                <Link
                  :href="route('user.show', vehicle.id)"
                  class="
                    no-underline
                    hover:underline
                    text-cyan-600
              ...
              >
                <BaseButtons type="justify-start lg:justify-end" no-wrap>
                  <BaseButton
                    v-if="can.edit"
                    :route-name="route('user.edit', vehicle.id)"
                    color="info"
